        ...
        <nav className="nav-extended indigo darken-4">
            ...
            <div className="nav-content">
                <ul className="tabs tabs-transparent">
                    <li className="tab"><NavLink exact to = "/">Главная</NavLink></li>
                    <li className="tab"><NavLink to = "/adminpoint">Администрирование</NavLink></li>
                    <li className="tab"><NavLink to = "/config">Настройки</NavLink></li>
                </ul>
            </div>
        </nav>
    )
