...
var printoutShema = new mongoose.Schema({
    ...
    start_printouts: {type: Number, required: true},
    start_col_printouts: {type: Number, required: false, default:0},
    start_bw_printouts: {type: Number, required: false, default:0}
});
